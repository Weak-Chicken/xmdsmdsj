...
> 
> After I thinking again, I would like suggest that this method isn't a good idea. So like the user distinguishing task, here I'll change everything to use article id to distinguish articles, rather than their titles. This would involve the router, data provider, editor page and user info page.
> 
